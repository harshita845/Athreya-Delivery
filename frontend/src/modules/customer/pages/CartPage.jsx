    ...
    return (
        <div className="relative isolate w-full overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(12,131,31,0.14),_transparent_34%),linear-gradient(180deg,_#f8faf9_0%,_#eef6f0_100%)] animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="pointer-events-none absolute inset-0">
                <div className="absolute -top-16 -right-16 h-52 w-52 rounded-full bg-[#1a6e2e]/10/20 blur-3xl" />
                ...
                {cart.length > 0 ? (
                    <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_22rem] xl:grid-cols-[minmax(0,1fr)_26rem]">
                        <section className="space-y-4">
                            ...
                            <div className="space-y-3">
                                {cart.map((item) => (
                                    <article
                                        ...
                                        className="group overflow-hidden rounded-[1.5rem] border border-white/80 bg-white/85   transition-transform duration-300 hover:-translate-y-0.5"
                                    >
                                            ...
                                            <div className="min-w-0 flex-1">
                                                <div className="flex items-start justify-between gap-3">
                                                    <div className="min-w-0">
                                                        <span className="inline-flex rounded-full bg-[#1a6e2e]/10 px-2.5 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-[#1a6e2e]">
                                                            {item.category}
                                                        </span>
                                                ...
                                                <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                                    ...
                                                    <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-2 py-1 border border-[#1a6e2e]/20">
                                                        <button
                                                            onClick={() => updateQuantity(item.id, -1, item.variantSku)}
                                                            className="flex h-9 w-9 items-center justify-center rounded-full text-slate-600 transition-all hover:bg-white hover:text-slate-900 hover:border border-[#1a6e2e]/20 disabled:cursor-not-allowed disabled:opacity-30"
                                                        ...
                                                        <button
                                                            onClick={() => updateQuantity(item.id, 1, item.variantSku)}
                                                            className="flex h-9 w-9 items-center justify-center rounded-full text-slate-600 transition-all hover:bg-white hover:text-slate-900 hover:border border-[#1a6e2e]/20"
                                                        >
                            ...
                            <div className="flex flex-col gap-3 rounded-[1.5rem] border border-white/80 bg-white/80 p-4  sm:flex-row sm:items-center sm:justify-between">
                                <Link
                                    to="/categories"
                                    className="inline-flex items-center justify-center gap-2 rounded-full border border-[#1a6e2e]/20 bg-[#1a6e2e]/10 px-4 py-2.5 text-sm font-black text-[#1a6e2e] transition-colors hover:bg-[#1a6e2e]/10"
                                >
                                    Continue Shopping
                                    <ArrowRight size={16} />
                                </Link>
                        ...
                        <aside className="lg:sticky lg:top-28 h-fit">
                            <div className="overflow-hidden rounded-[2rem] border border-slate-100 bg-slate-900 text-white ">
                                <div className="bg-[radial-gradient(circle_at_top_right,_rgba(34,197,94,0.35),_transparent_38%),linear-gradient(180deg,_rgba(255,255,255,0.08),_transparent)] px-6 py-6">
                                    <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.22em] text-[#1a6e2e]">
                                        <ShieldCheck size={13} />
                                        Secure summary
                                    </div>
                                ...
                                <div className="space-y-4 px-6 pb-6">
                                    <div className="space-y-3 rounded-[1.5rem] bg-white/5 p-4 ">
                                        ...
                                        <div className="flex justify-between text-sm text-white/75">
                                            ...
                                            <span className="font-bold text-[#1a6e2e]">FREE</span>
                                        </div>
                                        <div className="border-t border-white/10 pt-4 flex items-center justify-between">
                                            <span className="text-base font-bold text-white/85">Total Amount</span>
                                            <span className="text-3xl font-black tracking-tight text-[#1a6e2e]">₹{cartTotal}</span>
                                        </div>
                                    </div>

                                    <Link to="/checkout" className="block">
                                        <Button className="h-14 w-full rounded-full bg-[#1a6e2e]/10 text-slate-950 hover:bg-[#1a6e2e]/10 text-base font-black flex items-center justify-center gap-2  transition-all">
                                    ...
                                    <div className="grid grid-cols-2 gap-3 text-xs font-bold uppercase tracking-[0.16em] text-white/55">
                                        <div className="rounded-2xl border border-white/10 bg-white/5 px-3 py-3">
                                            <Truck size={15} className="mb-2 text-[#1a6e2e]" />
                                            Fast delivery
                                        </div>
                                        <div className="rounded-2xl border border-white/10 bg-white/5 px-3 py-3">
                                            <ShieldCheck size={15} className="mb-2 text-[#1a6e2e]" />
                                            Secure payment
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="mx-auto max-w-2xl overflow-hidden rounded-[2rem] border border-white/80 bg-white/90  ">
                        <div className="relative px-6 py-12 md:px-12 md:py-16">
                            <div className="pointer-events-none absolute inset-0">
                                <div className="absolute -right-8 top-0 h-32 w-32 rounded-full bg-[#1a6e2e]/10/40 blur-3xl" />
                                <div className="absolute -left-12 bottom-0 h-40 w-40 rounded-full bg-lime-200/50 blur-3xl" />
                            </div>

                            <div className="relative text-center">
                                <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#1a6e2e]/20 bg-[#1a6e2e]/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.22em] text-[#1a6e2e]">
                                    <Sparkles size={12} />
                                    Empty cart
                                </div>

                                <div className="mx-auto mb-8 flex h-48 w-48 items-center justify-center rounded-[2rem] border border-[#1a6e2e]/20  from-brand-50 to-white  md:h-56 md:w-56">
                                    {emptyBoxData ? (
                                        <Lottie
