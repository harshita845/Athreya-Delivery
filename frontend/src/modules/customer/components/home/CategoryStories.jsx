...
const stories = [
    ...
    { id: 3, title: 'Organic', image: 'https://images.unsplash.com/photo-1542838132-92c53300491e?q=80&w=150&auto=format&fit=crop', color: 'border-[#1a6e2e]/20' },
    { id: 4, title: 'Under ₹99', image: 'https://images.unsplash.com/photo-1580913182749-51b1b1ae4e12?q=80&w=150&auto=format&fit=crop', color: 'border-[#1a6e2e]/20' },
    ...
    { id: 8, title: 'Freshness', image: 'https://images.unsplash.com/photo-1490818387583-1baba5e638af?q=80&w=150&auto=format&fit=crop', color: 'border-[#1a6e2e]/20' },
];
                    ...
                    {stories.map((story) => (
                        <div key={story.id} className="flex flex-col items-center gap-2 flex-shrink-0 cursor-pointer group snap-start">
                            <div className={`p-1 rounded-full border-2 ${story.color} transition-transform duration-300 group-hover:scale-110 group-active:scale-95`}>
                                <div className="h-16 w-16 md:h-20 md:w-20 rounded-full overflow-hidden border-2 border-white border border-[#1a6e2e]/20">
                            ...
                            <span className="text-[10px] md:text-xs font-black text-slate-700 tracking-tight uppercase group-hover:text-[#1a6e2e] transition-colors">{story.title}</span>
                        </div>
                    ))}
                </div>
            </div>
