...
const LowestPriceSection = ({ products, onSeeAll }) => {
  ...
  return (
    <div className="-mt-[40px] mb-4 md:-mt-[40px] md:mb-8">
      <div className="relative overflow-hidden bg-linear-to-br from-[#fbf9ff] via-[#f5f1ff] to-[#fbf9ff] pt-7 pb-2 md:pt-16 md:pb-4 border-y border-purple-100/50 shadow-sm md:shadow-[inset_0_-10px_40px_rgba(0,0,0,0.02)]">
