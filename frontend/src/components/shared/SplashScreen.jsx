...
const SplashScreen = ({ onFinished }) => {
  ...
  return (
    <div
      ref={containerRef}
      className="fixed inset-0 z-[99999] flex flex-col items-center justify-center bg-[#070b19] select-none overflow-hidden font-sans"
    >
      ...
      <div className="flex flex-col items-center gap-6 z-10 text-center px-4 max-w-sm sm:max-w-md w-full">
        ...
        <div 
          ref={logoRef}
          className="relative w-40 h-40 sm:w-52 sm:h-52 rounded-[2.5rem] bg-white/[0.03] backdrop-blur-md border border-white/10 shadow-[0_20px_50px_rgba(58,42,131,0.25)] flex items-center justify-center p-5 group overflow-hidden"
        >
        ...
        <div ref={textRef} className="flex flex-col gap-1.5 mt-2">
          <h1 className="text-2xl sm:text-3xl font-[1000] tracking-[0.12em] uppercase text-white flex items-center justify-center gap-2 drop-shadow-md">
